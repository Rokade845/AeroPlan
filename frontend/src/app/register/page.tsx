...
import { Compass, User, Mail, Lock, Eye, EyeOff, Loader2 } from 'lucide-react';
...
export default function Register() {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center relative px-6 py-12 overflow-hidden">
      {/* Glows */}
      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center mb-8 text-center">
          ...
          <p className="text-gray-400 mt-2 text-sm">Join AeroPlan to start designing custom trips with AI</p>
        </div>
        ...
        <p className="text-center mt-6 text-sm text-gray-400">
          ...
          <Link href="/login" className="text-indigo-400 font-bold hover:underline hover:text-indigo-300">
            Sign In
          </Link>
        </p>
      </div>
